<?php
class Md_Banner_IndexController extends Mage_Core_Controller_Front_Action
{
    public function indexAction()
    {
    	//var_dump(Mage::app()->getLayout()->createBlock('page/html_header')->setTemplate('page/html/header=phtml'));die;
    	/*
